...
def add_rep(current_rep: int, rep_points: int, buf_effect: bool) -> float:
...
def remove_rep(current_rep: int, rep_points: int, debuf_effect: bool) -> float:
    current_rep -= rep_points
    if debuf_effect:
